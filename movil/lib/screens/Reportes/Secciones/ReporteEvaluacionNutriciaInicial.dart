...
class ReporteEvaluacionNutriciaInicial extends StatefulWidget {
  @override
  _ReporteEvaluacionNutriciaInicialState createState() => _ReporteEvaluacionNutriciaInicialState();
}

class _ReporteEvaluacionNutriciaInicialState extends State<ReporteEvaluacionNutriciaInicial> {
  ...
  Widget _buildBody(context) {
    return  Padding(
        ...
        child: FutureBuilder(
          future: reportesHelper.getNutriciaInicial(),
