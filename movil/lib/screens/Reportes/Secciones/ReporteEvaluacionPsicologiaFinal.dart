...
class ReporteEvaluacionPsicologiaFinal extends StatefulWidget {
  @override
  _ReporteEvaluacionPsicologiaFinalState createState() => _ReporteEvaluacionPsicologiaFinalState();
}

class _ReporteEvaluacionPsicologiaFinalState extends State<ReporteEvaluacionPsicologiaFinal> {
  ...
  Widget _buildBody(context) {
    return  Padding(
        ...
        child: FutureBuilder(
          future: reportesHelper.getPsicologiaFinal(),
