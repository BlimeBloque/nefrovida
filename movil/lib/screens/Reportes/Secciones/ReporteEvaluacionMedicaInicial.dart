...
class ReporteEvaluacionMedicaInicial extends StatefulWidget {
  @override
  _ReporteEvaluacionMedicaInicialState createState() => _ReporteEvaluacionMedicaInicialState();
}

class _ReporteEvaluacionMedicaInicialState extends State<ReporteEvaluacionMedicaInicial> {
  ...
  Widget _buildBody(context) {
    return  Padding(
        ...
        child: FutureBuilder(
          future: reportesHelper.getMedicaInicial(),
