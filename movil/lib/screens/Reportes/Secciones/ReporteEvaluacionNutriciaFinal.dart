...
class ReporteEvaluacionNutriciaFinal extends StatefulWidget {
  @override
  _ReporteEvaluacionNutriciaFinalState createState() => _ReporteEvaluacionNutriciaFinalState();
}

class _ReporteEvaluacionNutriciaFinalState extends State<ReporteEvaluacionNutriciaFinal> {
  ...
  Widget _buildBody(context) {
    return  Padding(
        ...
        child: FutureBuilder(
          future: reportesHelper.getNutriciaFinal(),
