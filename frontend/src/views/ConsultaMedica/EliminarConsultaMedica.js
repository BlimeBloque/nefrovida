...
export default function EliminarConsultaMedica(props)
{
    ...
    const eliminar = () => {
        http.delete('/consultaMedica/'+props.idConsultaMedica)
            ...
            .catch( err => {
                console.log(err);
                props.history.push("/beneficiarios/"+props.idBeneficiario+"?eliminarMedica=0");
            })
    }
                ...
                <center>
                    <DialogContent>
                        <DialogContentText style={{color: "red"}}>
                            ¿Estás seguro/a de querer eliminar la consulta médica del {props.fecha} de {props.nombre}?
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions>
