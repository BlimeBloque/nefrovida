...
export default function EliminarAntecedentes(props)
{
    ...
    const eliminar = () => {
        http.delete('/antecedentes/'+props.idAntecedentes)
            ...
            .catch( err => {
                console.log(err);
                props.history.push("/beneficiarios/"+props.idBeneficiario+"?eliminarAntecedentes=0");
            })
    }
                ...
                <center>
                    <DialogContent>
                        <DialogContentText style={{color: "red"}}>
                            ¿Estás seguro/a de querer eliminar los antecedentes de {props.nombre}?
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions>
