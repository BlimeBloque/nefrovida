...
export default function EliminarExamenOrina(props)
{
    ...
    const eliminar = () => {
        http.delete('/examenOrina/'+props.idExamenOrina)
            ...
            .catch( err => {
                console.log(err);
                props.history.push("/beneficiarios/"+props.idBeneficiario+"?eliminarExamenOrina=0");
            })
    }
                ...
                <center>
                    <DialogContent>
                        <DialogContentText style={{color: "red"}}>
                            ¿Estás seguro/a de querer eliminar el examen de orina del {props.fecha} de {props.nombre}?
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions>
