...
export default function EliminarDepuracionCreatinina(props)
{
    ...
    const eliminar = () => {
        http.delete('/depuracionCreatinina/'+props.idDepuracionCreatinina)
            ...
            .catch( err => {
                console.log(err);
                props.history.push("/beneficiarios/"+props.idBeneficiario+"?eliminarDepuracionCreatinina=0");
            })
    }
                ...
                <center>
                    <DialogContent>
                        <DialogContentText style={{color: "red"}}>
                            ¿Estás seguro/a de querer eliminar la depuración de creatinina del {props.fecha} de {props.nombre}?
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions>
