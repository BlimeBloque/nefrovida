      ...
      return (
        <div>
          ...
          >
            ...
            <SecureRoute
              path="/jornadas/:idJornada([0-9]*)"
              exact={true}
              component={JornadaDetalles}
            />
            <SecureRoute path="/reportes" exact={true} component={Reportes} />

            <SecureRoute
              path="/jornadas/:idJornada([0-9]*)/agregarBeneficiario"
              exact={true}
              component={AgregarBeneficiario}
            />
            <SecureRoute
              path="/jornadas/comparar"
              exact={true}
              component={AgregarBeneficiario}
            />

            <SecureRoute
              path="/beneficiarios/:idBeneficiario([0-9]*)/agregarConsultaNutricion"
              exact={true}
              component={AgregarConsultaNutricion}
            />
            <SecureRoute
              path="/beneficiarios/:idBeneficiario([0-9]*)/agregarEvaluacionInicio"
              exact={true}
              component={AgregarEvaluacion}
            />
            <SecureRoute
              path="/beneficiarios/:idBeneficiario([0-9]*)/agregarEvaluacionFin"
              exact={true}
              component={AgregarEvaluacion}
            />
            <SecureRoute
              path="/beneficiarios/:idBeneficiario([0-9]*)/agregarAntecedentes"
              exact={true}
              component={AgregarAntecedentes}
            />
            <SecureRoute
              path="/beneficiarios/:idBeneficiario([0-9]*)/detalleEvaluacionesInicio"
              exact={true}
              component={DetalleEvaluacion}
            />
            <SecureRoute
              path="/beneficiarios/:idBeneficiario([0-9]*)/detalleEvaluacionesFin"
              exact={true}
              component={DetalleEvaluacion}
            />
            <SecureRoute
              path="/beneficiarios/:idBeneficiario([0-9]*)/editarEvaluacionInicio"
              exact={true}
              component={EditarEvaluacion}
            />
            <SecureRoute
              path="/beneficiarios/:idBeneficiario([0-9]*)/editarEvaluacionFin"
              exact={true}
              component={EditarEvaluacion}
            />
            ...
            {/* Tamizaje */}
            <SecureRoute
              path="/beneficiarios/:idBeneficiario([0-9]*)/tamizaje/agregar"
              exact={true}
              component={AgregarTamizaje}
            />
            <SecureRoute
              path="/beneficiarios/:idBeneficiario([0-9]*)/tamizaje/:idTamizaje([0-9]*)/editar"
              exact={true}
              component={EditarTamizaje}
            />
            <SecureRoute
              path="/beneficiarios/:idBeneficiario([0-9]*)/tamizaje/:idTamizaje([0-9]*)"
              exact={true}
              component={DetalleTamizaje}
            />

            <SecureRoute
              path="/beneficiarios/:idBeneficiario([0-9]*)/editar"
              exact={true}
              component={EditarBeneficiario}
            />
            <SecureRoute
              path="/consultaNutricion/:idConsultaNutricion([0-9]*)"
              exact={true}
              component={DetalleConsultaNutricion}
            />
            <SecureRoute
              path="/consultaNutricion/editar/:idConsultaNutricion([0-9]*)"
              exact={true}
              component={EditarConsultaNutricion}
            />

            <SecureRoute
              path="/beneficiarios/:idBeneficiario([0-9]*)/agregarAnalisisLab"
              exact={true}
              component={AgregarAnalisisLab}
            />
            <SecureRoute
              path="/beneficiarios/:idBeneficiario([0-9]*)/agregarExamenOrina"
              exact={true}
              component={AgregarExamenOrina}
            />
            <SecureRoute
              path="/examenOrina/:idExamenOrina([0-9]*)"
              exact={true}
              component={DetalleExamenOrina}
            />
            <SecureRoute
              path="/examenOrina/editar/:idExamenOrina([0-9]*)"
              exact={true}
              component={EditarExamenOrina}
            />
            <SecureRoute
              path="/beneficiarios/:idBeneficiario([0-9]*)/agregarDepuracionCreatinina"
              exact={true}
              component={AgregarDepuracionCreatinina}
            />
            <SecureRoute
              path="/depuracionCreatinina/:idDepuracionCreatinina([0-9]*)"
              exact={true}
              component={DetalleDepuracionCreatinina}
            />
            <SecureRoute
              path="/depuracionCreatinina/editar/:idDepuracionCreatinina([0-9]*)"
              exact={true}
              component={EditarDepuracionCreatinina}
            />
            <SecureRoute
              path="/beneficiarios/:idBeneficiario([0-9]*)/agregarQuimicaSanguinea"
              exact={true}
              component={AgregarQuimicaSanguinea}
            />
            <SecureRoute
              path="/quimicaSanguinea/:idQuimicaSanguinea([0-9]*)"
              exact={true}
              component={DetalleQuimicaSanguinea}
            />
            <SecureRoute
              path="/quimicaSanguinea/editar/:idQuimicaSanguinea([0-9]*)"
              exact={true}
              component={EditarQuimicaSanguinea}
            />
            <SecureRoute
              path="/beneficiarios/:idBeneficiario([0-9]*)/agregarMicroalbuminuria"
              exact={true}
              component={AgregarMicroalbuminuria}
            />
            <SecureRoute
              path="/microalbuminuria/:idMicroalbuminuria([0-9]*)"
              exact={true}
              component={DetalleMicroalbuminuria}
            />
            <SecureRoute
              path="/microalbuminuria/editar/:idMicroalbuminuria([0-9]*)"
              exact={true}
              component={EditarMicroalbuminuria}
            />

            <SecureRoute
              path="/beneficiarios/:idBeneficiario([0-9]*)/agregarNota"
              exact={true}
              component={AgregarNota}
            />
            <SecureRoute
              path="/nota/editar/:idNota([0-9]*)"
              exact={true}
              component={EditarNota}
            />

            <SecureRoute
              path="/nota/:idConsultaMedica([0-9]*)"
              exact={true}
              component={DetalleNota}
            />
            <SecureRoute
              path="/beneficiarios/:idBeneficiario([0-9]*)/agregarConsultaMedica"
              exact={true}
              component={AgregarConsultaMedica}
            />
            <SecureRoute
              path="/consultaMedica/:idConsultaMedica([0-9]*)"
              exact={true}
              component={DetalleConsultaMedica}
            />
            <SecureRoute
              path="/consultaMedica/editar/:idConsultaMedica([0-9]*)"
              exact={true}
              component={EditarConsultaMedica}
            />

            <SecureRoute
              path="/antecedentes/:idAntecedentes([0-9]*)"
              exact={true}
              component={DetalleAntecedentes}
            />
            <SecureRoute
              path="/antecedentes/editar/:idAntecedentes([0-9]*)"
              exact={true}
              component={EditarAntecedentes}
            />
